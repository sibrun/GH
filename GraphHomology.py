...
parser.add_argument('-mod_p', action='store_true', help='compute matrix rank modulo a prime number')
...
def rank(graph_complex):
    logger.warn("\n----- Compute Ranks -----\n")
    graph_complex.compute_rank(exact=args.exact, mod_p=args.mod_p, rheinfall=args.rheinfall,
