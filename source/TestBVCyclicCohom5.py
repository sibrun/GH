        ...
        for l in l_range:
            print(
                ...
                [ cohom_formatted_forested_top(
                    BVCyclic.ContractAReconnectDeleteTriOM.generate_operator(v, l),
                    BVCyclic.ContractAReconnectDeleteTriOM.generate_operator(v+1, l),
                    BVCyclic.AReconnectDeleteBiOM.generate_operator(v, l),
                    use_D1domain=False
                )  for v in v_range])
    return s
